    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (hasPipe) {
                ...
                List<List<String>> pipelineCommands = parsePipeline(tokens);
            ...
            if (input.equals("exit")) {
                ...
                if (stdoutRedirect != null) {
                    try (java.io.FileWriter writer = new java.io.FileWriter(stdoutRedirect, appendStdout)) {
                ...
                if (targetDir.exists() && targetDir.isDirectory()) {
                    ...
                    if (stderrRedirect != null) {
                        try (java.io.PrintWriter writer = new java.io.PrintWriter(new File(stderrRedirect))) {
                ...
                if (!found) {
                    if (stderrRedirect != null) {
                        try (java.io.FileWriter writer = new java.io.FileWriter(stderrRedirect, appendStderr)) {
                            writer.write(command.get(0) + ": not found\n");
                        }
                    } else {
